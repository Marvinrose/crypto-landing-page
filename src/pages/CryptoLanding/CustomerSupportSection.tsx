          ...
          <div className="flex items-center gap-9 self-stretch md:flex-col">
            <div className="relative h-[208px] w-full content-center md:h-auto">
              <div className="flex flex-1 flex-col items-start">
                <Img
                  src="images/img_ri_customer_service_2_fill.svg"
                  alt="Ricustomer"
                  className="h-[48px]"
                />
                <Heading
                  size="headingmd"
                  as="h3"
                  className="mt-3 !text-[20px] font-semibold !text-gray-900_06"
                >
                ...
                <div className="mt-[88px] flex gap-2 self-stretch py-2">
                  <Text
                    as="p"
                    className="!text-[14px] font-normal !text-teal-400"
                  >
                    Chat Now
                  </Text>
                  <Img
                    src="images/img_arrow_right_teal_400.svg"
                    alt="Arrowright"
                    className="h-[16px]"
                  />
                </div>
            ...
            <div className="w-full self-start">
              <div className="flex items-center">
                <div className="flex w-[22%] flex-col items-start">
                  <Img
                    src="images/img_flat_color_icons_faq.svg"
                    alt="Flatcolor"
                    className="h-[48px]"
                  />
                  <Heading
                ...
                >
                  For detailed instructions on specific features, please refer
                  to the FAQs.
                </Text>
              </div>
            </div>
            <div className="flex w-full items-center">
              <div className="mb-2 w-[24%]">
                <div className="flex flex-col items-start">
                  <Img
                    src="images/img_fluent_people_c.svg"
                    alt="Fluentpeoplec"
                    className="h-[48px]"
                  />
                  <Heading
              ...
              >
                With over 15 languages supported, the VeeWallet Global Community
                is home to millions of users from 20+ countries.
              </Text>
            </div>
          </div>
        </div>
