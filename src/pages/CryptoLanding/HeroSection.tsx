            ...
            <div className="flex flex-1 flex-col gap-9 bg-gray-100 md:self-stretch">
              <div className="flex flex-col items-start gap-4">
                ...
                >
                  ...
                  <span className="text-teal-400">Hodl your Favourite Cryptocurrencies</span>
                </Heading>
                <Text size="textxl" as="p" className="text-[20px] font-normal !text-gray-900_06">
              ...
              <div className="flex flex-col items-start gap-3.5 bg-gray-100">
                <div className="flex items-center gap-6 self-stretch sm:flex-col">
                  <Input
                    ...
                    suffix={
                      <Img src="images/img_lock.svg" alt="Lock" className="my-0.5 h-[16px] w-[16px] object-contain" />
                    }
                    className="w-[48%] gap-4 rounded-lg px-3"
                  />
                  <Button size="lg" shape="round" className="min-w-[140px] rounded-lg px-5 font-semibold">
                    Get Started
                  </Button>
                </div>
                <Text size="textmd" as="p" className="text-base font-normal !text-gray-500">
